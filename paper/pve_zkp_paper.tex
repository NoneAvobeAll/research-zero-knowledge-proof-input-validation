...
This paper is driven by the following research question: \emph{Can a browser
outsource input validation to an untrusted service in such a way that the final
receiving system can verify correct validation without learning raw inputs?} To
answer this question, we design and analyze a concrete system called PVE-ZKP
(Proof-of-Validated-Execution with zero-knowledge proofs) and study its
applicability as a building block for privacy-preserving input pipelines.

The research contributions of this paper are:
\begin{enumerate}[leftmargin=*]
  \item \textbf{Architecture.} We formalize a browser--validator--receiver
  ...
  \item \textbf{Prototype implementation.} We implement and open-source PVE-ZKP using Circom
  ...
  \item \textbf{Security analysis and limitations.} We analyze the trust and
